...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <div class="topleft">
    <a href="${pageContext.request.contextPath}/background/main.jsp" target="_parent"><img src="images/logo.png" title="系统首页" /></a>
    </div>
        
    <ul class="nav">
    <li><a href="default.html" target="rightFrame" class="selected"><img src="images/icon01.png" title="我的工作台" /><h2>我的工作台</h2></a></li>
